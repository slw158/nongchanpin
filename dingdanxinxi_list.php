        ...
        for ($i = $pagecurrent * $pagelarge - $pagelarge; $i < $ddddd; $i++) {
            ...
            <tr>
                ...
                <td align='center'><a
                            ...
                            onclick="return confirm('您确定要执行此操作？')"><?php echo mysql_result($query, $i, "issh") ?></a>
                </td>
                ...
                <td width="120" align="center"><a
                            ...
                            href="dingdanxinxi_updt.php?id=<?php echo mysql_result($query, $i, "id"); ?>">修改</a> <a
                            href="dingdanxinxi_detail.php?id=<?php echo mysql_result($query, $i, "id"); ?>">详细</a>
                </td>
            </tr>
            <?php
        }
...
<p>以上数据共<?php echo $rowscount; ?>条,
    <input type="button" name="Submit2" onclick="javascript:window.print();" value="打印本页"
           style='border:solid 1px #000000; color:#666666'/> <input type="button" name="Submit3"
                                                                    onclick="javascript:location.href='dingdanxinxi_listxls.php';"
                                                                    value="导出EXCEL"
                                                                    style='border:solid 1px #000000; color:#666666'/>
</p>
<p align="center"><a href="dingdanxinxi_list.php?pagecurrent=1">首页</a>, <a
            href="dingdanxinxi_list.php?pagecurrent=<?php echo $pagecurrent - 1; ?>">前一页</a> ,<a
            href="dingdanxinxi_list.php?pagecurrent=<?php echo $pagecurrent + 1; ?>">后一页</a>, <a
            href="dingdanxinxi_list.php?pagecurrent=<?php echo $pagecount; ?>">末页</a>,
