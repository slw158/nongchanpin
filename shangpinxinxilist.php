                                            ...
                                            <TD width=100% height="660" vAlign=top bgColor=#f9fdff>
                                                <form id="form1" name="form1" method="post" action="">
                                                    ...
                                                    <input type="submit" name="Submit" value="查找"
                                                           style='border:solid 1px #000000; color:#666666'/>&nbsp;
                                                    <input type="button" name="Submit3" value="切换视图"
                                                           style='border:solid 1px #000000; color:#666666'
                                                        ...
                                                        for ($i = $pagecurrent * $pagelarge - $pagelarge; $i < $ddddd; $i++) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="30" align="center"><a
                                                                            href="shangpinxinxidetail.php?id=<?php echo mysql_result($query, $i, "id"); ?>">详细</a>
                                                                </td>
                                                            </tr>
                                                            <?php
                                                        }
                                                ...
                                                <p align="center"><a href="shangpinxinxilist.php?pagecurrent=1">首页</a>,
                                                    <a href="shangpinxinxilist.php?pagecurrent=<?php echo $pagecurrent - 1; ?>">前一页</a>
                                                    ,<a href="shangpinxinxilist.php?pagecurrent=<?php echo $pagecurrent + 1; ?>">后一页</a>,
                                                    <a href="shangpinxinxilist.php?pagecurrent=<?php echo $pagecount; ?>">末页</a>,
                                                    当前第<?php echo $pagecurrent; ?>页,共<?php echo $pagecount; ?>页
                                                </p>
