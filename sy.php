...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><div style='float:left'> <img height="14" src="skin/images/frame/book1.gif" width="20" />&nbsp;欢迎使用 农产品网上销售系统，建站的首选工具。 </div>
...
<table width="98%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px;margin-top:8px;">
  ...
  <tr bgcolor="#FFFFFF">
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&gt;欢迎使用 农产品网上销售系统 ，有问题请联系系统管理员！ </td>
  </tr>
</table>
  ...
  <tr bgcolor="#FFFFFF">
    <td height="30" colspan="2" align="center" valign="bottom"><table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr>
          ...
          <td width="85%" valign="bottom"><p>作者：史李伟</p>
          <p>指导老师：李靖</p>
          <p>所在学院：计算机与技术学院</p></td>
        </tr>
      </table></td>
  </tr>
</table>
