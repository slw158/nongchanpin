    ...
    if ($rowscount == 0) {
        ...
        for ($i = $pagecurrent * $pagelarge - $pagelarge; $i < $ddddd; $i++) {
            ...
            <tr>
                ...
                <td align="center"><img src="<?php echo mysql_result($query, $i, zhaopian); ?>" width="73" height="77"/>
                </td>
                <td width="65" align="center"><a
                            href="sh.php?id=<?php echo mysql_result($query, $i, id); ?>&amp;yuan=<?php echo mysql_result($query, $i, issh); ?>&tablename=yonghuzhuce"><?php echo mysql_result($query, $i, issh); ?></a>
                </td>
                ...
                <td width="70" align="center"><a href="del.php?id=<?php
                    ...
                    ?>&tablename=yonghuzhuce" onclick="return confirm('真的要删除？')">删除</a> <a
                            href="yonghuzhuce_updt.php?id=<?php
                            echo mysql_result($query, $i, "id");
                            ?>">修改</a></td>
            </tr>
            <?php
...
<p align="center"><a href="yonghuzhuce_list.php?pagecurrent=1">首页</a>, <a
            href="yonghuzhuce_list.php?pagecurrent=<?php echo $pagecurrent - 1; ?>">前一页</a> ,<a
            href="yonghuzhuce_list.php?pagecurrent=<?php echo $pagecurrent + 1; ?>">后一页</a>, <a
            href="yonghuzhuce_list.php?pagecurrent=<?php echo $pagecount; ?>">末页</a>,
